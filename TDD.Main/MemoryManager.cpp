...
MemoryManager::MemoryManager(size_t bufferSize)
...
std::pmr::memory_resource* MemoryManager::getResource() {
    return &pool_;
}

std::unique_ptr<std::pmr::memory_resource, MemoryManager::CustomDeleter> MemoryManager::createClientResource(size_t clientBufferSize) {
    ...
    // Deleter
    MemoryManager::CustomDeleter deleter =
    ...
    return std::unique_ptr<std::pmr::memory_resource, MemoryManager::CustomDeleter>(
